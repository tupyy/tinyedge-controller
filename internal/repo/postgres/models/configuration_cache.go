...
[ 1] configuration                                  BYTEA                null: true   primary: false  isArray: false  auto: false  col: BYTEA           len: -1      default: []


JSON Sample
-------------------------------------
{    "device_id": "xhRZpCBlnTyyOeyGbTQfLwmuw",    "configuration": "YlSuopMhmRHlvTRIPkUjMpGJQ"}
...
type ConfigurationCache struct {
	...
	//[ 1] configuration                                  BYTEA                null: true   primary: false  isArray: false  auto: false  col: BYTEA           len: -1      default: []
	Configuration sql.NullString `gorm:"column:configuration;type:BYTEA;"`
}
...
var configuration_cacheTableInfo = &TableInfo{
	...
	Columns: []*ColumnInfo{
		...
		&ColumnInfo{
			...
			ColumnType:         "BYTEA",
			ColumnLength:       -1,
			GoFieldName:        "Configuration",
			GoFieldType:        "sql.NullString",
			JSONFieldName:      "configuration",
			ProtobufFieldName:  "configuration",
			ProtobufType:       "string",
			ProtobufPos:        2,
		},
	},

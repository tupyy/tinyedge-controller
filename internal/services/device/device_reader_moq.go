...
func (mock *DeviceReaderWriterMock) GetConfiguration(ctx context.Context, id string) (entity.Configuration, error) {
	if mock.GetConfigurationFunc == nil {
		panic("DeviceReaderWriterMock.GetConfigurationFunc: method is nil but DeviceReaderWriter.GetConfiguration was just called")
	}
	callInfo := struct {
		Ctx context.Context
		ID  string
...
// Check the length with:
//
//	len(mockedDeviceReaderWriter.GetConfigurationCalls())
func (mock *DeviceReaderWriterMock) GetConfigurationCalls() []struct {
	Ctx context.Context
	ID  string
} {
	var calls []struct {
